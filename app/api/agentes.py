...
def _agente_out(agente: Agente, db: Session) -> AgenteOut:
    ...
    return AgenteOut(
        ...
        resgate_modo=getattr(agente, "resgate_modo", "desligado") or "desligado",
        resgate_max_tentativas=getattr(agente, "resgate_max_tentativas", 3),
        resgate_intervalo_horas=getattr(agente, "resgate_intervalo_horas", 24),
        resgate_hora_inicio=getattr(agente, "resgate_hora_inicio", 8),
        resgate_hora_fim=getattr(agente, "resgate_hora_fim", 20),
...
def criar_agente(
    ...
    agente = Agente(
        ...
        resgate_modo=payload.resgate_modo,
        resgate_max_tentativas=payload.resgate_max_tentativas,
        resgate_intervalo_horas=payload.resgate_intervalo_horas,
        resgate_hora_inicio=payload.resgate_hora_inicio,
        resgate_hora_fim=payload.resgate_hora_fim,
...
def atualizar_agente(
    ...
    for campo in (
        ...
        "tempo_followup_min",
        "resgate_modo",
        "resgate_max_tentativas",
        "resgate_intervalo_horas",
        "resgate_hora_inicio",
        "resgate_hora_fim",
        "horario_modo",
    ):
