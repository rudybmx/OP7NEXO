...
from app.api.criativos_carrossel import router as criativos_carrossel_router
...
from app.api.public_agendar import router as public_agendar_router
...
app.include_router(criativos_carrossel_router)
...
app.include_router(public_agendar_router)
