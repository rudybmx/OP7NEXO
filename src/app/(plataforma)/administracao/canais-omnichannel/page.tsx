...
import { Loader2, Plus, Search, X, Copy, Check, Link2 } from 'lucide-react'
        ...
        {TIPOS.map(t => (
          <div
            ...
            style={{
              ...
              border: filtroTipo === t.id ? `1px solid ${t.cor}` : '1px solid var(--ws-glass-border)',
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid var(--ws-glass-border)' }}>
                {['Nome', 'Tipo', 'Cliente', 'Status', 'Ações'].map(h => (
                  <th key={h} style={{
