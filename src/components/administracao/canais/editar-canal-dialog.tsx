      ...
      >
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px 28px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            {canal?.tipo === 'whatsapp_oficial' && (
              <div
                style={{
                  background: 'rgba(7,94,84,0.06)',
                  border: '1px solid rgba(7,94,84,0.20)',
                  borderRadius: 12,
                  padding: '16px 18px',
                }}
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12, gap: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--ws-text-1)' }}>WhatsApp Oficial (Meta Cloud)</div>
                      <div style={{ fontSize: 12, color: 'var(--ws-text-3)', marginTop: 2 }}>
                        {canal.numero_telefone ?? 'Nenhum número validado'}
                      </div>
                    </div>
                  </div>
                  <span
                  ...
                  <div style={{ marginBottom: 12 }}>
                    ...
                    <div style={{
                      ...
                      <code style={{ fontSize: 11, color: 'var(--ws-text-1)', wordBreak: 'break-all', lineHeight: 1.5, display: 'block' }}>
                        https://api.op7franquia.com.br/webhook/meta/{canal.webhook_token}
                      </code>
                    </div>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  {canal.connection_status === 'connected' ? (
                    ...
                    <button
                      ...
                      style={{
                        flex: 1, height: 38, borderRadius: 8,
                        background: conectando ? 'rgba(7,94,84,0.30)' : 'rgba(7,94,84,0.15)',
                        border: '1px solid rgba(7,94,84,0.40)',
                        fontSize: 13, fontWeight: 600, color: '#075E54',
                        cursor: conectando ? 'not-allowed' : 'pointer',
                        display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                      }}
                    >
