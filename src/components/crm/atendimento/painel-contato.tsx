...
import { CalendarClock, Phone, User, Users, MessageSquare } from 'lucide-react'
...
export function PainelContato({ conversa, workspaceId, onAtualizar }: PainelContatoProps) {
