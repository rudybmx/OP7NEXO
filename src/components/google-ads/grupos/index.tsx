...
export function AbaGruposGoogle({ dateRange, adsAccountId }: { dateRange: { start: Date; end: Date }; adsAccountId?: string }) {
  ...
  const { grupos, campanhasUnicas } = useGoogleGrupos(filtros, dateRange, adsAccountId)
