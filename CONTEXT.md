...
- Roadmap: Fase 2 (IA grava `nome_confirmado` com alta confiança), Fase 3 (análise no contato), Fase 4 (gate `pode_acessar_crm` + teto via `crm_escopo` já em prod), Fase 5 (front lê `nome_confirmado`).
