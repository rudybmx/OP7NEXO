...
- **Próximo**: persistir brand-kit/logos por workspace; templates reais (DB) com áreas seguras; partials progressivos; (opcional) Playwright WYSIWYG no worker. Billing/vídeo em specs separados.
