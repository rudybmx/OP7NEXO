...
- Roadmap: ~~Fase 1, Fase 2~~ (feitas) · Fase 3 (resumo/interesse no contato), Fase 4 (gate `pode_acessar_crm` + teto via `crm_escopo` já em prod), Fase 5 (front lê `nome_confirmado`).
